...
func aplicar_verde_no_circulo(circulo):
	...
	if circuloXQtd == 1:
		level2.bracoQuebrado.texture = level2.braco_metade_enfaixado
	
	if  circuloXQtd == 0:
		level2.bracoQuebrado.texture = level2.braco_enfaixado
		level2.mensagem.text = "Braço enfaixado, hora de colocar a tala."
