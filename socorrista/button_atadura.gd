...
var circuloX = preload("res://sprites socorristas/circulo riscado.png")
...
func aplicar_x_no_circulo(circulo):
	var sprite := circulo.get_parent() as Sprite2D
	sprite.texture = circuloX
	sprite.z_index = 999
	...
	if  circuloXQtd == 0:
		level3.bracoQueimadura.texture = level3.braco_atadura
